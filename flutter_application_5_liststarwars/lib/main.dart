...
class _MyHomePageState extends State<MyHomePage> {
  List<Planets> planet = PlanetResponse.fromJson(jsonDecode(
            ...
            itemBuilder: (context, index) {
              return Card(
                ...
                Padding(
                    ...
                    child: Text(planet.elementAt(index).name.toUpperCase(),
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Card(
                ...
                Padding(
                    padding: const EdgeInsets.all(10.0),
                    child: Text(people.elementAt(index).name.toUpperCase(),
                        style: const TextStyle(
