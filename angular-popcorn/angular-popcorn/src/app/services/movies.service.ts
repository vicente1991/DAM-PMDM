...
import { Genre, GenreElement } from '../models/interfaces/genre.interface';
...
export class MoviesService {
  ...
  getGenreList(): Observable<Genre>{
    return this.http.get<Genre>(`https://api.themoviedb.org/3/genre/movie/list?api_key=${environment.apiKey}&language=en-US`);
  }
}
